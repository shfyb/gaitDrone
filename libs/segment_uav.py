...
from mmseg.seg_demo_uav import seg_image
...
# 全局初始化模型（在程序开始处执行一次）
seg_config = './demo/checkpoints/Tinypedseg/deeplabv3plus_resnet_tos.py'  # 替换为你的配置文件路径
seg_checkpoint = './demo/checkpoints/Tinypedseg/best_mDice_iter_2400.pth'  # 替换为你的模型权重路径
...
'''
                    #调用 seg_image 函数进行分割
                    seg_image(frame, seg_config, seg_checkpoint, save_name, savesil_path)
