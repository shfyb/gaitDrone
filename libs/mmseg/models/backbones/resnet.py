...
class ResNet(BaseModule):
    ...
    def forward(self, x):
        ...
        #file = open('/mnt/disk2/tos_group/elvin_arda/mmsegmentation/probs.txt','a')
        #file.write(nn.functional.softmax(torch.FloatTensor(outs)))
        #shape_list = [t.size() for t in outs]
        #file.write(str(shape_list))
        #file.close()
        return tuple(outs)
