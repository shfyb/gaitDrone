...
from modeling.modules import GradualWarmupScheduler

__all__ = ['BaseModel']

model_cfgs = {  
    # "gait_model": "./demo/checkpoints/gait_model/Baseline-250000.pt"
    "gait_model": "./demo/checkpoints/gait_model/GaitBase_DroneGait2_200-60000.pt"
}
...
class BaseModel(MetaModel, nn.Module):
    ...
    def get_scheduler(self, scheduler_cfg):
        ...
        if scheduler_cfg['enable_warmup']:
            scheduler = GradualWarmupScheduler(self.optimizer, multiplier=1, total_iteration=3000,
    ...
    def _load_ckpt(self, save_name):
        ...
        # model_state_dict['layernorm_mean.weight'] = model_state_dict.pop('layernorm_mean.layernorm.weight')
        # model_state_dict['layernorm_mean.bias'] = model_state_dict.pop('layernorm_mean.layernorm.bias')
