...
if __name__ == '__main__':
    ...
    if opt.test_visdrone:
        seqs_str = '''
                    ...
                    uav0000088_00290_v
                '''
        data_root = '/home/caiqingyuan/suhui/DepthMOT-master/src/data/Visdrone2019/test'
    ...
    main(opt,
         ...
         save_images=True,
         save_videos=False) 
# python track.py mot  --load_model ../models/fairmot_dla34.pth --conf_thres 0.4 --test_visdrone True