...
def tinyobjectsegmentation_classes():
    """TinyObjectSegmentation class names for external use."""
    return ['background','pedestrian']
...
def tinyobjectsegmentation_palette():
    """TinyObjectSegmentation palette for external use."""
    return [[0, 0, 0], [256, 256, 256]]
...
dataset_aliases = {
    'tinyobjectsegmentation': ['tinyobjectsegmentation'],
...
def get_classes(dataset):
    ...
    alias2name = {}
    print('items: ',dataset_aliases.items())
